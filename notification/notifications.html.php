...
$sql = 'UPDATE user SET lastnotificationcount = '.$notificationcount.' WHERE id = '.$uid;
...
try{
    ...
    $error = "Unable TO Update all-notification counter";
    $error2 = $e -> getMessage();
    ...
    <div class='col-sm-6'>
        <div class="row">
                    ...
                    <ul class="pagination">
                        <?php for($i=0; $i < $no_of_pages; $i++):?>
                            <li <?php if($i == $pgn){echo("class='active';"); }?>>
                                <a href="/api/notification/?getusernotifications&&pgn=<?php echo $i; ?>">
                                    <?php echo $i; ?>
                                </a> </li>
                        <?php endfor;?>
                    </ul>
            ...
            <?php foreach($notifications as $n):?>
                    <?php if($n["userid"] != $_SESSION["userid"]):?>
                        ...
                        <div class="commentnotificationdiv">
                            ...
                            <div style="display: inline-block">
                                ...
                                <h5 class="commentnotificationh5">
                                    ...
                                    <a href="/api/article/?gaid=<?php echo($n["postid"]);?>">
                                        <i>This Post</i>
                                    </a>
                        ...
                        <div class="commentnotificationdiv">
                            ...
                            <div style="display: inline-block" class="notificationdiv">
                                ...
                                <h5>
                                    ...
                                    <a href="/api/article/?reply&takeid=<?php echo($n["postid"]);?>&RL=1">
                                        <i>This Comment</i>
                                    </a>
                    ...
                    <?php elseif($n["notificationtypeid"] == 3):?>
                        <div class="commentnotificationdiv">
                            ...
                            <div style="display: inline-block" class="notificationdiv">
                                    ...
                                    <h5>
                                        <?php echo($n["firstname"])?> Also Replied To
                                        <a href="/api/article/?reply&takeid=<?php echo($n["postid"]);?>&RL=2">
                                            <i>This Reply</i>
                                        </a>
