...
$description = 'Privacy Policy Of kpakpandomedia.com By KpakpandoMedia Nigeria';
include_once $_SERVER['DOCUMENT_ROOT'].'/bona/inc/htmls/header.html.php'?>

<div class="container-fluid">
    <div class="row banner-fadein text-center">
        <h2 class="page-header">Privacy Policy</h2>
        <h6>Kpakpando Media</h6>
    </div>
    ...
    <div class='col-sm-6'>
        <div class="row" style="border: 10px solid #224422;">

            <h4 class="page-header text-center text-capitalize">
                privacy policy
            </h4>
            <section class="text-capitalize">

                <h5 class="page-header">last updated: 18-08-2017</h5>
                <p>
                    we, KpakpandoMedia nigeria operate https://www.kpakpandomedia.com.
                ...
                <p>
                    you can reach us for more clarifications at:
                    <p>
                    address:
                    </p>
                    umeokwonnabonaventure@gmail.com
                    <br>telephone: 07034667861
    ...
    <div class="col-sm-3">
        <div class="row">
            <div class="col-sm-12">
                <button id="backbtn" class="btn" style="background: transparent; border: 0;">
                    Go Back
                </button>
