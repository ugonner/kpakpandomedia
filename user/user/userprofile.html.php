                           ...
                           <div class="form-group">
                               <form class="form-group"
                                   ...
                                   <div class="form-group">
                                       ...
                                       <select name='location' id='locationselectpf' class="form-control">
...
<script type="text/javascript">
    ...
    function displaysublocationspf(){
        ...
        $.get('http://localhost/api/location/index.php?get_sublocations&locationid='+sid, function(responseText) {
