            ...
            <div class="container-fluid"  style="background: black !important;">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right" >
                    ...
                    <ul class="nav navbar-nav" >
                        ...
                        <li><a class="btn btn-lg " href="/api/article/?gabc&cid=3">Events</a></li>
                        <li><a class="btn btn-sm " href="/api/article/?gabc&cid=1">Achievements</a></li>
                        <li><a class="btn btn-sm " href="/api/article/?gabc&cid=2">Activities</a></li>
                        ...
                        <li class="has-child"><a href="#" class="btn ">Cluster Updates</a>
                            <ul class="submenu">
